...
Gem::Specification.new do |spec|
  ...
  if spec.respond_to?(:metadata)
    spec.metadata["allowed_push_host"] = "https://github.com/NehaChopra/json2xslx"
  else
  ...
  spec.add_development_dependency "spreadsheet", "~> 1.1.4"
  spec.add_development_dependency "multi_json", "~> 1.8.2"
end
